...
CREATE TABLE recipes(id SERIAL PRIMARY KEY, meal varchar(255), name varchar(255), image_url varchar(225), description varchar(225), instructions text, user_id INT references users(id));
